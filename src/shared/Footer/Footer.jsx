    ...
    return (
        <div>
            <footer className="px-4 divide-y ">
                    ...
                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-1">
                                ...
                                <li>
                                    <NavLink className="text-center" to="/a">All Assignments</NavLink>
                                </li>
                                <li>
                                    <NavLink className="text-center" to="/a">Submitted Assignments</NavLink>
                                </li>
                                <li>
                                    <NavLink className="text-center" to="/a">My Assignments</NavLink>
                                </li>

                                <li>
                                    <NavLink to="/a">Create Assignments</NavLink>
                                </li>
                            </ul>
                        </div>
                        <div className="space-y-3">
                ...
                <div className="py-6 text-sm text-center dark:text-gray-400">© 2023 Collab Learn. All rights reserved.</div>
            </footer>
        </div>
    );
};
